 ...
 * This program is to conduct real-world scenario to verify the GRA model.
...
if __name__ == '__main__':
    ...
    # Solving the GRA model
	T_Matrix, status, objective_value, T_pairs = Assignment.GRA(orig_QMatrix, L)
	# print(T_Matrix)
	print(L)
	print(status)
